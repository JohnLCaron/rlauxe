...
data class MultiContestCombineDataOld(
    ...
    private fun makeCvr(cvrbs: CvrBuilders, fcontests: List<ContestVoteTrackerOld>): Cvr {
...
// TODO switch to Vunder?
data class ContestVoteTrackerOld(
    val contest: Contest,
) {
