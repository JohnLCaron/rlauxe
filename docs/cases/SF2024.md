...
The total mvrs needed are dominated by the assertions with the lowest margin. In the above plots, contest 14 has an assertion that
...
removed for exceeding the Max Sample Limit, set at 20,000. We'd like to explore how CLCA and OneAudit differ when
the n lowest-margin contests are removed from the audit.

<a href="https://johnlcaron.github.io/rlauxe/docs/plots2/cases/SF2024RemoveNnmaxLinear.html" rel="SF2024RemoveNnmax">![SF2024RemoveNnmax](../plots2/cases/SF2024RemoveNnmaxLinear.png)</a>
...
are likely to be removed. For SF2024, the top 2 contests (14 and 28) have recount margin less than .005, and
would go to a full hand count immediately. For OneAudit, close contests fail to complete and so the number of successful contests 
for OneAudit (OA nsuccess) are less than the number of successful CLCA contests. 

So its only after the first 2 contests are removed that the comparision between CLCA and OneAudit become meaningful.
Starting with n=2, OneAudit needs about 5x more nmvrs than CLCA for SF2024. 
This is a much worse result than for [Boulder 2024](Boulder2024.md), likely due to the percentage ballots in pools (3% vs 13%), and
...
|----|----------|-------------|----------|------------|-------|-----------------------------------------------------------------------|
| 0  | 48       | 46.3        | 13562    | 15016      | 1.1   | [6522, 6851, 7800, 11176, 12977, 14759, 21078, 27154, 36046, 36047]   |
| 1  | 47       | 45.2        | 3498     | 10267      | 2.9   | [6352, 6417, 6646, 7132, 8749, 9350, 10692, 13905, 28337, 28338]      |
| 2  | 46       | 44.5        | 1771     | 9195       | 5.2   | [5347, 5353, 6414, 7528, 8223, 9219, 9433, 12804, 23822, 23823]       |
| 3  | 45       | 44.1        | 1093     | 7005       | 6.4   | [3972, 4742, 4853, 5139, 6631, 6835, 10186, 11417, 13866, 13867]      |
| 4  | 44       | 43.4        | 1024     | 4588       | 4.5   | [3212, 3272, 3299, 3959, 5127, 5145, 5155, 5839, 8307, 8308]          |
| 5  | 43       | 42.5        | 820      | 4546       | 5.5   | [2844, 3387, 3916, 4369, 4375, 4519, 5849, 6290, 7074, 7075]          |
| 6  | 42       | 41.7        | 742      | 3022       | 4.1   | [2292, 2468, 2595, 2686, 3055, 3064, 3079, 3823, 5014, 5015]          |
| 7  | 41       | 40.7        | 727      | 2266       | 3.1   | [1747, 1779, 1859, 2130, 2246, 2609, 2814, 2890, 2985, 2986]          |
| 8  | 40       | 39.9        | 597      | 2314       | 3.9   | [1516, 1870, 2032, 2092, 2195, 2222, 2994, 3419, 3465, 3466]          |
| 9  | 39       | 38.8        | 552      | 1435       | 2.6   | [1107, 1123, 1176, 1311, 1396, 1509, 1572, 1687, 2483, 2484]          |
| 10 | 38       | 37.8        | 459      | 1206       | 2.6   | [879, 965, 1082, 1181, 1233, 1245, 1444, 1525, 1700, 1701]            |
