...
has a mean = 1334 and stddev = 791.
...
TODO: do simulations include overshoot?
...
|                   |  total     | total   | diluted|             |          | Shangrla |         |           | Rlauxe   |
| Contest           | turnout    | batches | margin | sample size | K-M BLCA | OneAudit | Wald BP | BLCA/CLCA | OneAudit |
|-------------------|------------|---------|--------|-------------|----------|----------|---------|-----------|----------|
