...
class TestBravo  {
    ...
    fun runBravoRepeat(eta0: Double, trueMeans: List<Double>, withoutReplacement: Boolean ): List<RepeatedResult> {
        val N = 20_000
        val m = 2000
        val nrepeat = 1000
        val results = mutableListOf<RepeatedResult>()
    ...
    fun runBravo(N : Int, m: Int, eta0 : Double, trueMean: Double, withoutReplacement: Boolean, nrepeat:Int = 1): RepeatedResult  {
    ...
    fun runBravo(drawSample : SampleFn, m: Int, trueMean: Double, nrepeat:Int = 1, withoutReplacement: Boolean = true): RepeatedResult  {
...
fun show(title: String, eta0s: List<Double>, trueMeans: List<Double>, results: List<RepeatedResult>) {
    println(title)
