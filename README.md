...
These results are generated by our current single round (no estimation phase) CLCA algorithms with maxRisk = .9, and would be different with other choices of algorithm parameters.
