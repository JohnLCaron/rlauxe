...
These results are generated by our single round (no estimation phase) CLCA algorithm with maxRisk = 90%, and would be different with other choices of algorithm parameters. (A least squares plot would be more accurate but we dont actually use this approximate fit in our algorithms.)
