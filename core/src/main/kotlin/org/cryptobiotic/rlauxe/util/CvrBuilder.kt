...
class CvrBuilder2(
    ...
    companion object {
        ...
        fun addSeq(): CvrBuilder2 {
            count++
            return CvrBuilder2("card$count")
        }
        ...
        fun convertCvrsToBuilders(cvrs: List<Cvr>): List<CvrBuilder2> {
            return cvrs.map { fromCvr(it) }
        }
    }
}
