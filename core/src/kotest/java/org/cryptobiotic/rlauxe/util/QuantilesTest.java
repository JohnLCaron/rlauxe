...
import org.cryptobiotic.rlauxe.util.Quantiles.ScaleAndIndexes;
...
public class QuantilesTest  extends TestCase {
    ...
    public void testMedian_compute_doubleCollection() {
        assertThat(Quantiles.INSTANCE.median().compute(SIXTEEN_SQUARES_DOUBLES))
    ...
    public void testMedian_computeInPlace() {
        ...
        assertThat(Quantiles.INSTANCE.median().computeInPlace(dataset)).isWithin(ALLOWED_ERROR).of(SIXTEEN_SQUARES_MEDIAN);
    ...
    public void testQuartiles_index_compute_doubleCollection() {
        assertThat(Quantiles.INSTANCE.quartiles().index(1).compute(SIXTEEN_SQUARES_DOUBLES))
                .isWithin(ALLOWED_ERROR)
    ...
    public void testQuartiles_index_computeInPlace() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.quartiles().index(1).computeInPlace(dataset))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_QUARTILE_1);
        assertThat(dataset).usingExactEquality().containsExactlyElementsIn(SIXTEEN_SQUARES_DOUBLES);
    }
    ...
    public void testQuartiles_indexes_varargs_compute_doubleCollection() {
        assertThat(Quantiles.INSTANCE.quartiles().indexes(1, 3).compute(SIXTEEN_SQUARES_DOUBLES))
    ...
    public void testQuartiles_indexes_varargs_computeInPlace() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.quartiles().indexes(1, 3).computeInPlace(dataset))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
    ...
    public void testScale_index_compute_doubleCollection() {
        assertThat(Quantiles.INSTANCE.scale(10).index(1).compute(SIXTEEN_SQUARES_DOUBLES))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_DECILE_1);
    }

    public void testScale_index_compute_longCollection() {
        assertThat(com.google.common.math.Quantiles.scale(10).index(1).compute(SIXTEEN_SQUARES_LONGS))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_DECILE_1);
    }

    public void testScale_index_compute_integerCollection() {
        assertThat(com.google.common.math.Quantiles.scale(10).index(1).compute(SIXTEEN_SQUARES_INTEGERS))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_DECILE_1);
    }
    ...
    public void testScale_index_compute_doubleVarargs() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.scale(10).index(1).compute(dataset))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_DECILE_1);
        assertThat(dataset)
                .usingExactEquality()
    ...
    public void testScale_index_computeInPlace() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.scale(10).index(1).computeInPlace(dataset))
                .isWithin(ALLOWED_ERROR)
                .of(SIXTEEN_SQUARES_DECILE_1);
        assertThat(dataset).usingExactEquality().containsExactlyElementsIn(SIXTEEN_SQUARES_DOUBLES);
    }
    ...
    public void testScale_index_computeInPlace_explicitVarargs() {
        assertThat(Quantiles.INSTANCE.scale(10).index(5).computeInPlace(78.9, 12.3, 45.6))
                .isWithin(ALLOWED_ERROR)
                .of(45.6);
    }
    ...
    public void testScale_indexes_varargs_compute_doubleCollection() {
        ...
        assertThat(Quantiles.INSTANCE.scale(10).indexes(0, 10, 5, 1, 8, 1).compute(SIXTEEN_SQUARES_DOUBLES))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
    ...
    public void testScale_indexes_varargs_compute_doubleCollection_snapshotsIndexes() {
        ...
        ScaleAndIndexes intermediate = Quantiles.INSTANCE.scale(10).indexes(indexes);
        indexes[0] = 3;
    ...
    public void testScale_indexes_largeVarargs_compute_doubleCollection() {
        ...
        assertThat(
                Quantiles.INSTANCE.scale(scale).indexes(0, scale, otherIndex).compute(SIXTEEN_SQUARES_DOUBLES))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
    ...
    public void testScale_indexes_varargs_compute_longCollection() {
        // Note that we specify index 1 twice, which by the method contract should be ignored.
        assertThat(com.google.common.math.Quantiles.scale(10).indexes(0, 10, 5, 1, 8, 1).compute(SIXTEEN_SQUARES_LONGS))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, SIXTEEN_SQUARES_MIN,
                        10, SIXTEEN_SQUARES_MAX,
    ...
    public void testScale_indexes_varargs_compute_integerCollection() {
        // Note that we specify index 1 twice, which by the method contract should be ignored.
        assertThat(com.google.common.math.Quantiles.scale(10).indexes(0, 10, 5, 1, 8, 1).compute(SIXTEEN_SQUARES_INTEGERS))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, SIXTEEN_SQUARES_MIN,
                        10, SIXTEEN_SQUARES_MAX,
    ...
    public void testScale_indexes_varargs_compute_doubleVarargs() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.scale(10).indexes(0, 10, 5, 1, 8, 1).compute(dataset))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, SIXTEEN_SQUARES_MIN,
                        10, SIXTEEN_SQUARES_MAX,
    ...
    public void testScale_indexes_varargs_computeInPlace() {
        double[] dataset = Doubles.toArray(SIXTEEN_SQUARES_DOUBLES);
        assertThat(Quantiles.INSTANCE.scale(10).indexes(0, 10, 5, 1, 8, 1).computeInPlace(dataset))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, SIXTEEN_SQUARES_MIN,
                        10, SIXTEEN_SQUARES_MAX,
    ...
    public void testScale_indexes_varargs_computeInPlace_explicitVarargs() {
        assertThat(Quantiles.INSTANCE.scale(10).indexes(0, 10).computeInPlace(78.9, 12.3, 45.6))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, 12.3,
                        10, 78.9);
    ...
    public void testScale_index_compute_doubleCollection_positiveInfinity() {
        ...
        assertThat(Quantiles.INSTANCE.scale(10).index(9).compute(ONE_TO_FIVE_AND_POSITIVE_INFINITY))
                .isPositiveInfinity();
    }
    ...
    public void testScale_index_compute_doubleCollection_negativeInfinity() {
        ...
        assertThat(Quantiles.INSTANCE.scale(10).index(1).compute(ONE_TO_FIVE_AND_NEGATIVE_INFINITY))
                .isNegativeInfinity();
    }
    ...
    public void testScale_indexes_varargs_compute_doubleCollection_nan() {
        assertThat(Quantiles.INSTANCE.scale(10).indexes(0, 1, 2, 8, 9, 10).compute(ONE_TO_FIVE_AND_NAN))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactly(
                        0, NaN,
                        1, NaN,
    ...
    public void testScale_index_compute_doubleCollection_nan() {
        assertThat(Quantiles.INSTANCE.scale(10).index(5).compute(ONE_TO_FIVE_AND_NAN)).isNaN();
    }
    ...
    public void testPercentiles_index_compute_doubleCollection() {
        for (int index = 0; index <= 100; index++) {
            assertWithMessage("quantile at index %s", index)
                    .that(Quantiles.INSTANCE.percentiles().index(index).compute(PSEUDORANDOM_DATASET))
                    .isWithin(ALLOWED_ERROR)
    ...
    public void testPercentiles_index_computeInPlace() {
        ...
        for (int index = 0; index <= 100; index++) {
            ...
            assertWithMessage("quantile at index %s", index)
                    .that(Quantiles.INSTANCE.percentiles().index(index).computeInPlace(dataset))
                    .isWithin(ALLOWED_ERROR)
                    .of(expectedLargeDatasetPercentile(index));
        }
        ...
        double actual = Quantiles.INSTANCE.percentiles().index(33).computeInPlace(dataset);
    ...
    public void testPercentiles_indexes_varargsPairs_compute_doubleCollection() {
        for (int index1 = 0; index1 <= 100; index1++) {
            for (int index2 = 0; index2 <= 100; index2++) {
                ...
                assertThat(Quantiles.INSTANCE.percentiles().indexes(index1, index2).compute(PSEUDORANDOM_DATASET))
                        .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
    ...
    public void testPercentiles_indexes_varargsAll_compute_doubleCollection() {
        ...
        assertThat(Quantiles.INSTANCE.percentiles().indexes(Ints.toArray(indexes)).compute(PSEUDORANDOM_DATASET))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactlyEntriesIn(expectedBuilder.buildOrThrow());
    }
    ...
    public void testPercentiles_indexes_varargsAll_computeInPlace() {
        ...
        Random random = new Random(770683168895677741L);
        Collections.shuffle(indexes, random);
        assertThat(Quantiles.INSTANCE.percentiles().indexes(Ints.toArray(indexes)).computeInPlace(dataset))
                .comparingValuesUsing(QUANTILE_CORRESPONDENCE)
                .containsExactlyEntriesIn(expectedBuilder.buildOrThrow());
        assertThat(dataset).usingExactEquality().containsExactlyElementsIn(PSEUDORANDOM_DATASET);
    }
    ...
    public void testScale_zero() {
        assertThrows(IllegalArgumentException.class, () -> Quantiles.INSTANCE.scale(0));
    }

    public void testScale_negative() {
        assertThrows(IllegalArgumentException.class, () -> Quantiles.INSTANCE.scale(-4));
    }

    public void testScale_index_negative() {
        Quantiles.Scale intermediate = Quantiles.INSTANCE.scale(10);
    ...
    public void testScale_index_compute_doubleCollection_empty() {
        Quantiles.ScaleAndIndex intermediate = Quantiles.INSTANCE.scale(10).index(3);
    ...
    public void testScale_indexes_varargs_compute_doubleCollection_empty() {
        Quantiles.ScaleAndIndexes intermediate = Quantiles.INSTANCE.scale(10).indexes(1, 3, 5);
        assertThrows(IllegalArgumentException.class, () -> intermediate.compute(EMPTY_DATASET));
    }
    ...
    public void testScale_indexes_indexes_computeInPlace_empty() {
        ...
        assertThrows(
                ...
                () -> {
                    Quantiles.ScaleAndIndexes unused = Quantiles.INSTANCE.scale(10).indexes(emptyIndexes);
                });
    }
}