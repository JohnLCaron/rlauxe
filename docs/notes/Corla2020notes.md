...
* San Juan has a population < 1000, and is left out of the totals.
* could use Gunnison cvrs to synthesize its entry in tabulate_county.csv, or leave out of total?
* could use Baca and Las Animas tabulate_county.csv entries to synthesize cvrs, or leave out of total?
* could add Boulder redacted ballots back in (by simulation).
...
see where its takes too much time and parellelize