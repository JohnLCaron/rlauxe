...
class TestAssorterPlurality {
    ...
    fun testTwoCandidatePlurality() {
        ...
        assertEquals(winner.dilutedMean(), winnerAvg)
        ...
        assertEquals(loser.dilutedMean(), loserAvg)
    }
    ...
    fun testThreeCandidatePluralityAssorter() {
        ...
        assertEquals(winner12.dilutedMean(), winnerAvg, doublePrecision)
    }
    ...
    fun test3way(contest : Contest, cvrs: List<Cvr>, counts: List<Int>, winner: Int, loser:Int, other: Int): Double {
        ...
        assertEquals(assort.dilutedMean(), assortAvg, doublePrecision)
