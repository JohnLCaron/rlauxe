...
class ColoradoElectionSummary {

    @Test
    fun showMargins() {
        val contests = readSummaryCsv("/home/stormy/dev/github/rla/data/coloradoRLA/summary.csv")
...
fun readSummaryCsv(filename: String): List<Contest> {
    ...
    try {
        while (records.hasNext()) {
            ...
            if (currContest == null || bmi.contestName != currContest.contestName) {
                currContest = Contest(bmi.contestName, bmi.overVotes, bmi.underVotes)
