...
class TestSf2024OneAuditIrv() {
    ...
    fun testSf2024oa() {
        ...
        println("rassorter calcMargin from mvrs= ${rassorter.calcMarginFromVotes(irvVotes, Npop)}")
    ...
    fun testDivideMarginInVotes() {
        ...
        println("rassorter calcMargin from mvrs= ${rassorter.calcMarginFromVotes(allVotes, Npop)}")
        println("  all calcMarginInVotes= ${rassorter.calcVoteMargin(allVotes)}")
        ...
        println("  first calcMarginInVotes= ${rassorter.calcVoteMargin(firstVotes)}")
        ...
        println("  second calcMarginInVotes= ${rassorter.calcVoteMargin(secondVotes)}")

        assertEquals(rassorter.calcVoteMargin(allVotes), rassorter.calcVoteMargin(firstVotes)+rassorter.calcVoteMargin(secondVotes))
    }
    ...
    fun testMarginInVotes() {
        ...
        val allVotes = allTab.irvVotes.makeVotes(rcontestUA.ncandidates)
        println("rassorter calcMargin from mvrs= ${rassorter.calcMarginFromVotes(allVotes, Npop)}")
        println("  mvr calcMarginInVotes= ${rassorter.calcVoteMargin(allVotes)}")
        val expectedMvrVotes = rassorter.calcVoteMargin(allVotes)
    ...
    fun testVerifyOApools() {
        ...
        val cvrMargin = if (rcontestUA.isIrv) {
            ...
            println("  cvrs calcMarginInVotes= ${rassorter.calcVoteMargin(cvrVotes)}")
            rassorter.calcMarginFromVotes(cvrVotes, nonpoolTab.ncardsTabulated)
        } else {
