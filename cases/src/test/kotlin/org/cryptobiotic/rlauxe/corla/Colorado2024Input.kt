...
// remove in favor of Colorado2024AuditCenterInput
class Colorado2024Input: ColoradoInput(
    generalCanonicalFile = "src/test/data/corla/2024audit/2024GeneralCanonicalList.csv",
    contestRoundFile = "src/test/data/corla/2024audit/round1/contest.csv",
    tabulateCountyFile = "src/test/data/corla/2024audit/tabulateCounty.csv",
    mvrComparisonFile = "src/test/data/corla/2024audit/round3/contestComparison.csv"
) {
