...
class TestVunder {
    ...
    fun testMakeVunderCvrsVotesFor2() {
        ...
        val cvrs = makeCvrsForOnePoolV(vunders, "poolName", poolId = 42, hasExactContests = false)
...
fun makeContestsWithVunder(
   ...
   //TODO val cvrs2 = makeCvrsFromPopulations(test.populations)
    ...
    val cvrs = makeCvrsForOnePoolV(contestVotes, "ballot", poolId = 42, hasExactContests = false)
