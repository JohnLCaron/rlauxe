...
class AdaptiveComparison {
    fun plotSuccessVsMargin() {
        ...
        srtPlot(
            ...
            srts,
            "/home/stormy/temp/bet/plotAdaptiveComparison.plotSuccessVsMargin.${ntrials}.html",
    ...
    fun plotSuccess20VsMargin() {
        ...
        srtPlot(
            ...
            "for N=$N ntrials=$ntrials p2prior=$p2prior d2=$d2",
            srts,
            "/home/stormy/temp/bet/plotAdaptiveComparison.plotSuccess20VsMargin.${ntrials}.html",
    ...
    fun plotFailuresVsTheta() {
        ...
        srtPlot(
            ...
            "for N=$N ntrials=$ntrials p2prior=$p2prior d2=$d2",
            srts,
            "/home/stormy/temp/bet/plotAdaptiveComparison.plotFailuresVsTheta.${ntrials}.html",
