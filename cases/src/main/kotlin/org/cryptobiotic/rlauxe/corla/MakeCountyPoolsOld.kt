...
class MakeCountyPoolsOld(
    ...
    val countyPoolsMS: List<CountyPoolFromStyle>
    ...
    init {
        ...
        val missingContestsByCounty = mutableMapOf<String, MutableList<CountyContestVotes>>() // countyName -> contestTab
        ...
        this.countyPoolsMS = countyPools.map { countyPool ->
            ...
            val tabs = countyPool.cct.contests.map { (name, countyContestVotes) ->
            ...
            CountyPoolFromStyle(countyPool.countyName, countyPoolId++,
                voteTotals = tabs.associateBy { it.contestId }, infos = infos, hasExactContests = true)
        }
    }
    ...
    fun makeMissingPools(missingContestsByCounty: Map<String, List<CountyContestVotes>>): Map<String, CountyPoolFromStyle> {
    ...
    fun makeMissingPool(countyName: String, missingContests: List<CountyContestVotes>): CountyPoolFromStyle {
        ...
        return CountyPoolFromStyle(
            ...
            voteTotals = votesForStyle, infos = infos,
        )
    }
}
...
data class CountyPoolsBuilderOld(
    ...
    fun makePools(): List<CountyPoolFromStyle>  {
        ...
        val pools = mvrStyles.styles.values.map { style ->
            ...
            nextPoolId++
            CountyPoolFromStyle( countyName, nextPoolId,
...
data class CountyPoolFromStyle(
    ...
    override val poolName = "$countyName=$poolId"
