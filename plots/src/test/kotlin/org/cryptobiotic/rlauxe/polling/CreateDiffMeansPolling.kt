...
class CreatePollingDiffMeans {
    ...
    fun createPollingDiffMeansConcurrent() {
        ...
        val writer = SRTcsvWriter("/home/stormy/temp/PollingDiffMeans/SRT$nrepeat.csv")
    ...
    fun runAlphaMartWithMeanDiff(
        ...
        contestUA.pollingAssertions.map { assert ->
            ...
            val cvrSampler = PollWithoutReplacement(contestUA.contest as Contest, cvrs, assert.assorter)
