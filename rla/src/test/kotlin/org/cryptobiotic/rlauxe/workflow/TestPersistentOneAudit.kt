...
class TestPersistentOneAudit {
    val auditDir = "/home/stormy/temp/persist/testPersistentOneAudit"
    ...
    fun testPersistentWorkflowClca() {
        ...
        val N = 5000
        val contestOA = makeContestOA(N+100, N-100, cvrPercent = .95, 0.0, undervotePercent=.0, phantomPercent = .0)
