...
class TestAvgAssortValues {
    ...
    fun testAvgAssortValuesSmall() {
        ...
        checkAssorterAvg1(oaContest1, allCvrs, show = true)
        ...
        checkAssorterAvg1(oaContest2, mvrs2)
    ...
    fun testAvgAssortValues() {
        ...
        println("\noaContest1 with merged")
        checkAssorterAvg1(oaContest1, allCvrs)
