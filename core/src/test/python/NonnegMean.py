...
class NonnegMean:
    ...
    # called "Universal Portfolio" from UI-TS SF_oneaudit_example.ipynb
    ...
    # called "ALPHA" from UI-TS SF_oneaudit_example.ipynb
    ...
    # called "COBRA" from UI-TS SF_oneaudit_example.ipynb
    ...
    # called "AGRAPA" from UI-TS SF_oneaudit_example.ipynb
    #     'test':             NonnegMean.betting_mart,
...
# optimal_comparison: 213 :  1.11 min   aka COBRA

# from SHANGRLA Dominion.py
