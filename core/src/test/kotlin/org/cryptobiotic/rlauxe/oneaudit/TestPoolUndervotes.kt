...
// assumes Np = 0
fun makeSmallContest(name: String, id:Int, Nc: Int, nwinners:Int = 1): OneAuditContest { // TODO set margin
    // the candidates
    ...
    val votesCvr = mapOf(0 to part[0],1 to part[1])                                                       // pool: c1, c2, undervotes
    val votesNoCvr = mapOf(0 to part[3],1 to part[4])                                                       // pool: c1, c2, undervotes
