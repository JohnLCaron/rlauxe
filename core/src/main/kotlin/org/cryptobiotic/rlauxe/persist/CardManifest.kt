...
class CardManifest(val cards: CloseableIterable<AuditableCard>, val ncards: Int) {
    ...
    companion object {
        ...
        fun createFromList(cards: List<CardWithBatchName>, batches: List<CardStyleIF>) : CardManifest {
        ...
        fun createFromIterable(cards: CloseableIterable<CardWithBatchName>, batches: List<CardStyleIF>, ncards: Int) : CardManifest {
