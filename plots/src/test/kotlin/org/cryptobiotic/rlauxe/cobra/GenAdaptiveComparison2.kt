...
// updates version of GenAdaptiveComparison, to see if anything changed
class GenAdaptiveComparison2 {
/*
    @Test
    fun genAdaptiveComparisonPolling() {
        ...
        val ntrials = 1000
        val p2prior = .0001
        val d1 = 100 // (1.0/p2prior).toInt()/10
        ...
        reportedMeans.forEach { reportedMean ->
            p2s.forEach { p2 ->
                ...
                val mvrs = makeCvrsByExactMean(Nc, reportedMean)
